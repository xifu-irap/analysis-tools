...
def to_signed(val, nbits):
    r"""This function converts a positive integer value into
    a string corresponding to the signed hexadecimal value
    ...
    ----------
        ...
        nbits :integer
            number of bits of the value (position of the sign bit)
