...
def power_spectrum_from_error(dataPath, npts, win, remove_dc=True):
    ...
    print("Processing science file ", fileName)
    ...
    xf, spectrum = gt.do_power_spectrum(colDataEng, cst.fRow, npts, window=win)
...
def pltNspOneCol(dir_path, win, remove_dc = True, enob=11.5, npts=2**18):
    ...
    xf, spectrum_db = power_spectrum_from_error(pathData, npts, win, remove_dc=remove_dc)
    ...
    xlims = [0, cst.fRow/2/1e6]
    ylims = [-160, 0]

    lbl1 = "Spectrum (RBW = {0:.4}Hz)".format(rbw)
...
path = [
    "/Users/laurent/Data/TestPlan21-perfo/20250109_153836_errorEnob-col2",
    "/Users/laurent/Data/TestPlan21-perfo/20250109_154454_errorEnob-col1",
    "/Users/laurent/Data/TestPlan21-perfo/20250109_155508_errorEnob-col3",
    "/Users/laurent/Data/TestPlan21-perfo/20250109_155655_errorEnob-col0"
]
#win = "none"
win = "blackman"
for p in path[:]:
    pltNspOneCol(p, win, remove_dc=True, npts=2**22)